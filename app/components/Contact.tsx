...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/moralesseba",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/sebastian-ignacio-morales-calderon-435846341/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Email",
    href: "mailto:moralessebastyan@gmail.com",
    icon: (
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <p className="text-gray-400 leading-relaxed">
              ...
              quieres charlar sobre tecnología? Escríbeme y te respondo lo antes posible.
            </p>
